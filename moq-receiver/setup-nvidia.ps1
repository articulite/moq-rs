# Setup script for NVIDIA hardware acceleration in moq-receiver
...
Write-Host "Building moq-receiver with hardware acceleration..." -ForegroundColor Cyan
cargo build

# Run the receiver
Write-Host "You can now run the receiver with: cargo run -- --server https://localhost:4443 --name desktop" -ForegroundColor Green 