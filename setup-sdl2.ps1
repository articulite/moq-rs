...
Write-Host "SDL2 setup complete. SDL2.lib and SDL2.dll have been copied to the current directory."
Write-Host "You can now build the moq-receiver application." 