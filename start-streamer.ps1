...
# Run the streamer with hardware acceleration enabled via environment variables
Write-Host "Starting MoQ Streamer with hardware acceleration..." -ForegroundColor Cyan
